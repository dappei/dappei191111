...
<h2>${currentUser.username}登錄成功!!!</h2>

	<h2>歡迎您,${currentUser.username}</h2>
                ...
                <div class="aa-language">
                  <div class="dropdown">
                    <a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                      <img src="img/flag/english.jpg" alt="english flag">英文
                      <span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                      <li><a href="#"><img src="img/flag/french.jpg" alt="">德國</a></li>
                      <li><a href="#"><img src="img/flag/english.jpg" alt="">英國</a></li>
                    </ul>
                  </div>
                </div>
                <!-- / language -->
        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-collapse collapse" >
            ...
            <ul class="nav navbar-nav">
              ...
              <li><a href="blog-archive.html">部落格 <span class="caret"></span></a>
                <ul class="dropdown-menu">                
      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="img/slider/05.jpg" alt="Men slide img" />
              </div>
              <div class="seq-title">
               <span data-seq>情侶專區</span>                
                <h2 data-seq>居家時尚嚴選</h2>                
                <p data-seq></p>
                <a data-seq href="#" class="aa-shop-now-btn aa-secondary-btn">去購物</a>
              </div>
            </li>
            <!-- single slide item -->
            <li>
              <div class="seq-model">
                <img data-seq src="img/slider/01.jpg" alt="Women img" />
              </div>
              <div class="seq-title">
                <span data-seq>熱門穿搭</span>                
                <h2 data-seq>風衣精選</h2>                
                <p data-seq></p>
                <a data-seq href="#" class="aa-shop-now-btn aa-secondary-btn">去購物</a>
              </div>
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="img/slider/02.jpg" alt="Men hair img" />
              </div>
              <div class="seq-title">
                <span data-seq>熱門造型</span>                
                <h2 data-seq>男士髮型精選</h2>                
                <p data-seq></p>
                <a data-seq href="#" class="aa-shop-now-btn aa-secondary-btn">看文章</a>
              </div>
            </li>
            <!-- single slide item -->           
            <li>
              <div class="seq-model">
                <img data-seq src="img/slider/03.jpg" alt="Hat selection img" />
              </div>
              <div class="seq-title">
                <span data-seq>貝雷帽</span>                
                <h2 data-seq>嚴選配件</h2>                
                <p data-seq></p>
                <a data-seq href="#" class="aa-shop-now-btn aa-secondary-btn">去購物</a>
              </div>
            ...
            <!-- single slide item -->  
             <li>
              <div class="seq-model">
                <img data-seq src="img/slider/04.jpg" alt="clown img" />
              </div>
              <div class="seq-title">
                <span data-seq>分析小丑的秘密</span>                
                <h2 data-seq>精選文章</h2>                
                <p data-seq></p>
                <a data-seq href="#" class="aa-shop-now-btn aa-secondary-btn">看文章</a>
              </div>
              ...
              <div class="aa-product-inner">
                <!-- start prduct navigation -->
                 <ul class="nav nav-tabs aa-products-tab">
                    <li class="active"><a href="#men" data-toggle="tab">短袖</a></li>
                    <li><a href="#women" data-toggle="tab">長袖</a></li>
                    <li><a href="#sports" data-toggle="tab">短褲</a></li>
                    <li><a href="#electronics" data-toggle="tab">長褲</a></li>
                  </ul>
                  <!-- Tab panes -->
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      ...
                      <a class="aa-browse-btn" href="#">所有產品 <span class="fa fa-long-arrow-right"></span></a>
                    </div>
                ...
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <address>
                      <p> B300</p>
                      <p><span class="fa fa-phone"></span>02-6631-6666</p>
                      <p><span class="fa fa-envelope"></span>dappei109gmail.com</p>
                    </address>
