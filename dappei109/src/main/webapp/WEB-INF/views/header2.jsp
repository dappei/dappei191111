  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" style="font-size: 20px" href="dappeiwall">穿搭 </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" style="font-size: 20px" href="${pageContext.request.contextPath}/events">活動</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" style="font-size: 20px" href="${pageContext.request.contextPath}/blog">部落格</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" style="font-size: 20px" href="${pageContext.request.contextPath}/products">購物</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" style="font-size: 20px" href="${pageContext.request.contextPath}/antfont">消息</a>
      </li>
