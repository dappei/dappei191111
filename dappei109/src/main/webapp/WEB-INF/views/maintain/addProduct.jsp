...
<body>
	...
	<fieldset >
		...
		<div class="form-group">
			<label class="control-label col-lg-2 col-lg-2"  for='color'>產品顏色</label>
				<div class="col-lg-10">
		...
		<div class="form-group">
			<label class="control-label col-lg-2 col-lg-2"  for='size'>產品尺寸</label>
				<div class="col-lg-10">
		...
		<div class="form-group">
			<label class="control-label col-lg-2 col-lg-2"  for='productNo'>產品簡編號</label>
				<div class="col-lg-10">
		...
		<div class="form-group">
			<label class='control-label col-lg-2 col-lg-2' for="productImage">產品圖片</label>
				<div class='col-lg-10'>
