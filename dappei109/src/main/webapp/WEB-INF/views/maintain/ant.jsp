...
<body>
	...
	<div style="text-align: center" class="jumbotron">
		<h1>編輯消息</h1>
		<h3>
			<a href="<c:url value='/ant/add'/>">新增消息</a><br>
		</h3>
		<h3>
	...
	<table id="myTable" class="table table-striped table-bordered" style="width: 90%" >
		...
		<tbody>
			<c:forEach var="ant" items="${antList}">
				<tr>
					<td style="width:160px"><img style="width:150px; height:100px" src="<c:url value='/getAntPicture/${ant.antid}'/>"></td>
					...
					<td style="width:60px"><a class="btn btn-secondary my-2 my-sm-0" href="<c:url value='/update/${ant.antid}'/>">Edit</a></td>
					<td style="width:100px"><a class="btn btn-secondary my-2 my-sm-0" href="deleteAnt?antid=${ant.antid}"
