...
<body>
	<div class="container" id="regispage">
				...
				<form:form method="POST" modelAttribute="memberBean"
					...
					<div class="form-group">
						...
						<form:input type="email" name="email" id="email" path="email"
							class="form-control input-lg" placeholder="Email Address" tabindex="1" />
					...
					<div class="form-group">
						...
						class="form-control input-lg" placeholder="Username" tabindex="4" />
					...
					<div class="form-group">
						...
						<div class="col-xs-15 date">
							<div class="input-group input-append date" id="datePicker">
								<form:input type="text" class="form-control input-lg" name="birthday" 
								path="birthday" placeholder="Birthday" autocomplete="off" tabindex="5" />
					...
					<div class="row">
						<div class="col-xs-12 col-md-6">
							<input type="submit" value="註冊" id="regis" class="btn btn-primary btn-block btn-lg"/>
						</div>
						<div class="col-xs-12 col-md-6">
							<input type="reset" class="btn btn-success btn-block btn-lg" value="重新填寫">
						</div>
					</div>
				</form:form>
			</div>
